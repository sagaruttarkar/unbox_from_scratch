...
public class LambdaTest_Safari_monthly {
//WebDriver driver;
...
//		driver.manage().window().maximize();
        ...
        capabilities.setCapability("platform", "macOS Big Sur");
	     ...
	     capabilities.setCapability("version", "14"); // If this cap isn't specified, it will just get the any available one
        capabilities.setCapability("resolution","1920x1080");
        capabilities.setCapability("build", "First Test");
        capabilities.setCapability("name", "Safari1 Test");
