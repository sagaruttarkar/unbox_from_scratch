...
public class reels2_login_ddd {

	WebDriver driver;

 @Test(priority=0,dataProvider="Handles")
	public  static void main(String l1) throws InterruptedException {
		...
		Thread.sleep(5000);
		 boolean bool = Boolean.parseBoolean(l1);
		...
		do {
		   ...
		   wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[1]/section/nav/div[2]/div/div/div[2]/div[3]/div/div[2]/div/div[1]/a/div/div[2]/div[1]/div/div")));
			...
			for(WebElement e : list){
				Thread.sleep(5000);
				System.out.println("handle name>>"+l1);
				System.out.println("below are views");
			System.out.println(e.getAttribute("href")+e.getText());
				Thread.sleep(5000);
				new Actions(driver).moveToElement(e).build().perform();
				System.out.println("below are likes and comments");
				System.out.println(e.getAttribute("href")+">>"+e.getText());
