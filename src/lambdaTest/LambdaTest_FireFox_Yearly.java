...
public class LambdaTest_FireFox_Yearly {
//WebDriver driver;
...
//		driver.manage().window().maximize();
        ...
        capabilities.setCapability("platform", "Windows 8");
	     ...
	     capabilities.setCapability("version", "89"); // If this cap isn't specified, it will just get the any available one
        capabilities.setCapability("resolution","1920x1080");
        capabilities.setCapability("build", "First Test");
        capabilities.setCapability("name", "FireFox2 Test");
...
//
	...
	public void HomePage_start7daystrial() throws Exception {
					...
					driver.findElement(By.id("reenter_password")).sendKeys("123456");
					Thread.sleep(2000);
