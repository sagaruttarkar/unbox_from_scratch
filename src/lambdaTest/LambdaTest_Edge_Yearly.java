...
public class LambdaTest_Edge_Yearly {
//WebDriver driver;
...
//		driver.manage().window().maximize();
        ...
        capabilities.setCapability("platform", "Windows 10");
	     ...
	     capabilities.setCapability("version", "92"); // If this cap isn't specified, it will just get the any available one
        capabilities.setCapability("resolution","1920x1080");
        capabilities.setCapability("build", "First Test");
        capabilities.setCapability("name", "Edge2 Test");
